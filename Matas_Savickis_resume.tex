...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
	 \resumeItem{Project}
	          {Developing Nasdaq Central Securities Depository(CSD https://nasdaqcsd.com/) system for various customers around the globe}
	 \resumeItem{Back-end}
	          {Java 11, Spring, JBoss, JUnit, Mockito, Oracle, PostgresSQL}
	 \resumeItem{Front-end}
