...
\section{Profile}
      	I am a software engineer seeking position where I can apply my knowledge and skills for continuous improvement. 
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: Java 8 11 17, C\# , Python, Javascript, Typescript, SQL, C++, C, Assembly, JSON, HTML, CSS, LaTeX, TLA+.}
      \hfill
    }
    \item{
	\textbf{Technologies}{: Spring, Java EE, Micronaut, Hibernate, Apache Tomcat, Akka, MySQL, ASP.NET Core, Entity framework, React, Redux, React native,  Microsoft SQL Server, Git.}
	\hfil
	}
  \resumeSubHeadingListEnd
%-----------OTHER-----------------
